...
/**
 * Created by aasteasu on 7/8/2015.
 */
...
//   permissions.
public class AccountManager_2 extends Activity {
    ...
    public static Intent newReturnAuthorizedUserIntent(Context context) {
        Intent intent = new Intent(context, AccountManager_2.class);
        ...
        (new AsyncTask<String, String,String>(){
            ...
            protected String doInBackground(String... arg0) {
                try {
                    ...
                    SpreadsheetUtils_2.setupSpreadsheetServiceInThisThread(
                            AccountManager_2.this, account);
                    // At this point we know we have permission, so we can just
                    // return and everything is fine.
                    AccountManager_2.this.finishWithAccount();
                    ...
                    AccountManager_2.this.startActivityForResult(
